...
final class Toggle_ComparableTests: XCTestCase {
    ...
    func test_comparable() throws {
        let toggle1 = Toggle(variable: "variable_1", value: .none, metadata: Metadata(description: "", group: ""))
        let toggle2 = Toggle(variable: "variable_2", value: .none, metadata: Metadata(description: "", group: ""))
